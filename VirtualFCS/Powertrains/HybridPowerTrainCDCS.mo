...
model HybridPowerTrainCDCS
  ...
  VirtualFCS.Control.EMS_CDCS ems_cdcs(I_max_FC_stack = i_L_FC_stack,I_min_FC_stack = I_nom_FC_stack, I_nom_FC_stack = I_rated_FC_stack, V_HV_Bus = V_HV_Bus)  annotation(
...
equation
  ...
  connect(getCurrentRequest.y, ems_cdcs.currentRequest) annotation(
    Line(points = {{-102, -24}, {-82, -24}}, color = {0, 0, 127}));
  connect(batterySystem.sensorOutput, ems_cdcs.sensorInputSOC) annotation(
    Line(points = {{-38, -72}, {-96, -72}, {-96, -32}, {-82, -32}}, color = {0, 0, 127}));
  connect(ems_cdcs.controlOutputFuelCellCurrent, dC_converter.I_Ref) annotation(
    Line(points = {{-58, -28}, {22, -28}, {22, -32}}, color = {0, 0, 127}));
protected
  annotation(

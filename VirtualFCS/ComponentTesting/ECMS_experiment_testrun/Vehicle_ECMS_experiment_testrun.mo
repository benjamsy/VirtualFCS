...
model Vehicle_ECMS_experiment_testrun
  ...
  VirtualFCS.ComponentTesting.ECMS_experiment_testrun.PowerTrainECMS_experiment_testrun powerTrainECMS_experiment_testrun(C_bat_pack = 2700, SOC_init = 0.99, V_max_bat_pack = 54.75, V_min_bat_pack = 37.5, V_nom_bat_pack = 48)  annotation(

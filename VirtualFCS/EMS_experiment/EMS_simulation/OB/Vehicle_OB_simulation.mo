...
model Vehicle_OB_simulation
  ...
  VirtualFCS.EMS_experiment.EMS_simulation.OB.PowerTrain_OB_simulation powerTrain_OB_simulation(C_bat_pack = 180, SOC_init = 0.3, V_max_bat_pack = 54.75, V_min_bat_pack = 37.5, V_nom_bat_pack = 48)  annotation(

within VirtualFCS.EMS_experiment.EMS_testrun;

model FuelCellSystem_testrun
  // System
  outer Modelica.Fluid.System system "System properties";
  parameter Modelica.Units.SI.Mass m_FC_system = fuelCellStack.m_FC_stack + 10;
  ...
  VirtualFCS.Electrochemical.Hydrogen.FuelCellStack fuelCellStack(H_FC_stack = H_FC_stack, I_rated_FC_stack = I_nom_FC_stack, L_FC_stack = L_FC_stack, N_FC_stack = N_FC_stack, W_FC_stack = W_FC_stack, m_FC_stack = m_FC_stack, vol_FC_stack = vol_FC_stack) annotation(
  ...
  VirtualFCS.EMS_experiment.EMS_testrun.FuelCellSubSystems_testrun fuelCellSubSystems_testrun annotation(
    Placement(visible = true, transformation(origin = {-1.39888e-14, -60}, extent = {{-26, -26}, {26, 26}}, rotation = 0)));
equation
  ...
  connect(multiplex2.y, fuelCellSubSystems_testrun.contolInput) annotation(
    Line(points = {{-42, -60}, {-31, -60}}, color = {0, 0, 127}, thickness = 0.5));
  connect(fuelCellStack.port_a_Coolant, fuelCellSubSystems_testrun.coolant_port_b) annotation(
    Line(points = {{-6, -6}, {-6, -20}, {-2, -20}, {-2, -36}}, color = {0, 127, 255}));
  connect(fuelCellStack.port_b_Coolant, fuelCellSubSystems_testrun.coolant_port_a) annotation(
    Line(points = {{4, -6}, {4, -20}, {2, -20}, {2, -36}}, color = {0, 127, 255}));
  connect(fuelCellStack.port_b_Air, fuelCellSubSystems_testrun.air_port_a) annotation(
    Line(points = {{18, -2}, {18, -36}}, color = {0, 127, 255}));
  connect(fuelCellStack.port_b_H2, fuelCellSubSystems_testrun.H2_port_a) annotation(
    Line(points = {{-20, -2}, {-18, -2}, {-18, -36}}, color = {0, 127, 255}));
  connect(fuelCellStack.port_a_H2, fuelCellSubSystems_testrun.H2_port_b) annotation(
    Line(points = {{-20, 22}, {-24, 22}, {-24, -36}}, color = {0, 127, 255}));
  connect(fuelCellStack.port_a_Air, fuelCellSubSystems_testrun.air_port_b) annotation(
    Line(points = {{18, 22}, {24, 22}, {24, -36}}, color = {0, 127, 255}));
protected
  annotation(

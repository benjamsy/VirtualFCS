...
model PowerTrain_ECMS
  ...
  Modelica.Blocks.Math.Gain gain(k = 100) annotation(
    Placement(visible = true, transformation(origin = {-133, -29}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  VirtualFCS.ECMS_experiment.EMS_ECMS ems_ecms(I_max_FC_stack = i_L_FC_stack, I_max_batt = 360,I_min_FC_stack = I_nom_FC_stack - 70, I_min_batt = -180, I_nom_FC_stack = I_rated_FC_stack, SOC_max = 0.9, SOC_min = 0.7, n_cell = N_FC_stack)  annotation(
...
equation
  ...
  connect(batterySystem.sensorOutput, gain.u) annotation(
    Line(points = {{-38, -72}, {-92, -72}, {-92, -64}, {-158, -64}, {-158, -29}, {-141, -29}}, color = {0, 0, 127}));
  ...
  connect(gain.y, ems_ecms.sensorInputSOC) annotation(
    Line(points = {{-126, -28}, {-82, -28}}, color = {0, 0, 127}));

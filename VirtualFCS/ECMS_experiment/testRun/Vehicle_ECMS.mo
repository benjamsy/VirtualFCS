...
model Vehicle_ECMS
  ...
  VirtualFCS.ECMS_experiment.testRun.PowerTrain_ECMS powerTrain_ECMS(C_bat_pack = 2700, SOC_init = 0.8, V_max_bat_pack = 54.75, V_min_bat_pack = 37.5, V_nom_bat_pack = 48)  annotation(
